...
import { RunnerMount } from "@/components/games/runner/RunnerMount";
...
export async function generateMetadata({
  ...
  return {
    ...
    description: t("runner.tagline"),
  };
}

/**
 * Server Component. Everything interactive lives behind RunnerMount,
 ...
 */
export default async function RunnerPage({ params }: { params: Promise<{ locale: string }> }) {
